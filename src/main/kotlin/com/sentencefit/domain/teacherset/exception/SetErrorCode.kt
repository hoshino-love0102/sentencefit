...
enum class SetErrorCode(
    ...
    SET_TITLE_TOO_LONG(HttpStatus.BAD_REQUEST, "세트 제목은 150자 이하여야 합니다."),
    SET_DESCRIPTION_TOO_LONG(HttpStatus.BAD_REQUEST, "설명은 1000자 이하여야 합니다."),
    SET_CLASS_NOT_FOUND(HttpStatus.NOT_FOUND, "세트를 생성할 클래스가 존재하지 않습니다."),
